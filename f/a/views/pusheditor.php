  ...
  <div id="main_container" class="main_container container_16 clearfix">
    ...
    <div class="flat_area grid_16">
      <h2>
        ...
        <div class="holder">
          <?php include 'includes/components/dynamic_loading.php';?></div>
      </h2>
    </div>
    <div class="box grid_16">

      <div class="block">
        <form id="article_editor" action="<?php echo site_url($ctl.'/new_push');?>
          " method="post" class='validate_form' enctype="multipart/form-data">
          ...
          <fieldset class="label_side top">
            <label>命令（选填）</label>
            <div>
              <input type="text" name="command" placeholder="请输入额外的命令参数..."></div>
          </fieldset>
          <fieldset class="label_side top">
            <label>内容（选填）</label>
            <div>
