					...
					<?php }?>
						...
						<div class="block">
							...
							<label>用户类型</label>
								...
								<input name="username" value="<?php echo set_value('username'); ?>" title="不输入则默认使用邮箱地址作为用户名，16个字符之内" type="text" class="large">
							
								<label>用户密码<?php echo form_error('pass'); ?></label> 
								<input name="pass" value="<?php echo set_value('password'); ?>" title="密码需6到16位字符" type="text" maxlength="16" class="medium required">
