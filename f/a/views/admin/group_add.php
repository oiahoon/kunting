	...
	<body>
		...
		<div id="main_container" class="main_container container_16 clearfix">
			...
			<div class="box grid_8 round_all">
					...
					<!--  错误提示  -->
					<?php if(''!=$message){?>
						<div class="alert alert_<?php echo $alert;?>">
					...
					<?php }?>
						...
						<div class="block">
							<?php echo form_open('/admin/admin/groupAdd/'); ?>
								<label>用户组名<?php echo form_error('group_name'); ?></label> 
								<input name="group_name" value="<?php echo set_value('group_name'); ?>" title="输入用户组名，16个字符之内" type="text" class="large">
								...
								<span style="float:right;color:#003366;font-size:16px;"><a href="index.php?/admin/admin/groups">←返回用户组列表</a></span>
							</form>
						</div>
					</div>
				</div>
